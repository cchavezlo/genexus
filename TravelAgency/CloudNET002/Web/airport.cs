   ...
   public class airport : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_3") == 0 )
         {
            ...
            gxLoad_3( A9CountryId, A15CityId) ;
            return  ;
         }
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtAirportId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A21AirportId), 4, 0, ".", "")), StringUtil.LTrim( ((edtAirportId_Enabled!=0) ? context.localUtil.Format( (decimal)(A21AirportId), "ZZZ9") : context.localUtil.Format( (decimal)(A21AirportId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAirportId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAirportId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtAirportName_Internalname, StringUtil.RTrim( A24AirportName), StringUtil.RTrim( context.localUtil.Format( A24AirportName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAirportName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAirportName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCountryName_Internalname, StringUtil.RTrim( A10CountryName), StringUtil.RTrim( context.localUtil.Format( A10CountryName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCityId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CityId), 4, 0, ".", "")), StringUtil.LTrim( ((edtCityId_Enabled!=0) ? context.localUtil.Format( (decimal)(A15CityId), "ZZZ9") : context.localUtil.Format( (decimal)(A15CityId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCityId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCityId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Airport.htm");
         /* Static images/pictures */
         ClassString = "gx-prompt Image" + " " + ((StringUtil.StrCmp(imgprompt_15_gximage, "")==0) ? "" : "GX_Image_"+imgprompt_15_gximage+"_Class");
         StyleString = "";
         sImgUrl = (string)(context.GetImagePath( "prompt.gif", "", context.GetTheme( )));
         GxWebStd.gx_bitmap( context, imgprompt_15_Internalname, sImgUrl, imgprompt_15_Link, "", "", context.GetTheme( ), imgprompt_15_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCityName_Internalname, StringUtil.RTrim( A16CityName), StringUtil.RTrim( context.localUtil.Format( A16CityName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCityName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCityName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            Z21AirportId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "Z21AirportId"), ".", ","), 18, MidpointRounding.ToEven));
            Z24AirportName = cgiGet( "Z24AirportName");
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtAirportId_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtAirportId_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               A21AirportId = 0;
               AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
            }
            else
            {
            ...
            AssignAttri("", false, "A24AirportName", A24AirportName);
         ...
         else
         {
            ...
            if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
            {
               ...
               A21AirportId = (short)(Math.Round(NumberUtil.Val( GetPar( "AirportId"), "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
               getEqualNoModal( ) ;
               Gx_mode = "DSP";
               AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void ZM067( short GX_JID )
      {
         if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z24AirportName = T00063_A24AirportName[0];
               Z9CountryId = T00063_A9CountryId[0];
               Z15CityId = T00063_A15CityId[0];
            }
            else
            {
               Z24AirportName = A24AirportName;
      ...
      {
         /* Using cursor T00066 */
         pr_default.execute(4, new Object[] {A21AirportId});
         if ( (pr_default.getStatus(4) != 101) )
         {
            RcdFound7 = 1;
            A24AirportName = T00066_A24AirportName[0];
            AssignAttri("", false, "A24AirportName", A24AirportName);
            A10CountryName = T00066_A10CountryName[0];
            AssignAttri("", false, "A10CountryName", A10CountryName);
            A16CityName = T00066_A16CityName[0];
            AssignAttri("", false, "A16CityName", A16CityName);
            A9CountryId = T00066_A9CountryId[0];
            AssignAttri("", false, "A9CountryId", StringUtil.LTrimStr( (decimal)(A9CountryId), 4, 0));
            A15CityId = T00066_A15CityId[0];
            AssignAttri("", false, "A15CityId", StringUtil.LTrimStr( (decimal)(A15CityId), 4, 0));
            ZM067( -1) ;
         }
         pr_default.close(4);
      ...
      protected void CheckExtendedTable067( )
      {
         ...
         A16CityName = T00065_A16CityName[0];
         AssignAttri("", false, "A16CityName", A16CityName);
         pr_default.close(3);
      }
      ...
      {
         /* Using cursor T00068 */
         pr_default.execute(6, new Object[] {A9CountryId, A15CityId});
         ...
         A16CityName = T00068_A16CityName[0];
         AssignAttri("", false, "A16CityName", A16CityName);
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      {
         /* Using cursor T00069 */
         pr_default.execute(7, new Object[] {A21AirportId});
      ...
      {
         /* Using cursor T00063 */
         pr_default.execute(1, new Object[] {A21AirportId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM067( 1) ;
            RcdFound7 = 1;
            A21AirportId = T00063_A21AirportId[0];
            AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
            A24AirportName = T00063_A24AirportName[0];
            AssignAttri("", false, "A24AirportName", A24AirportName);
            A9CountryId = T00063_A9CountryId[0];
            AssignAttri("", false, "A9CountryId", StringUtil.LTrimStr( (decimal)(A9CountryId), 4, 0));
            A15CityId = T00063_A15CityId[0];
            AssignAttri("", false, "A15CityId", StringUtil.LTrimStr( (decimal)(A15CityId), 4, 0));
            Z21AirportId = A21AirportId;
            sMode7 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         ...
         pr_default.execute(8, new Object[] {A21AirportId});
         if ( (pr_default.getStatus(8) != 101) )
         {
            while ( (pr_default.getStatus(8) != 101) && ( ( T000610_A21AirportId[0] < A21AirportId ) ) )
            {
               pr_default.readNext(8);
            }
            if ( (pr_default.getStatus(8) != 101) && ( ( T000610_A21AirportId[0] > A21AirportId ) ) )
            {
               A21AirportId = T000610_A21AirportId[0];
               AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
               RcdFound7 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         pr_default.execute(9, new Object[] {A21AirportId});
         if ( (pr_default.getStatus(9) != 101) )
         {
            while ( (pr_default.getStatus(9) != 101) && ( ( T000611_A21AirportId[0] > A21AirportId ) ) )
            {
               pr_default.readNext(9);
            }
            if ( (pr_default.getStatus(9) != 101) && ( ( T000611_A21AirportId[0] < A21AirportId ) ) )
            {
               A21AirportId = T000611_A21AirportId[0];
               AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
               RcdFound7 = 1;
            }
         }
      ...
      protected void btn_enter( )
      {
         ...
         else
         {
            if ( RcdFound7 == 1 )
            {
               if ( A21AirportId != Z21AirportId )
               {
                  A21AirportId = Z21AirportId;
                  AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
      ...
      protected void CheckOptimisticConcurrency067( )
      {
         ...
         {
            /* Using cursor T00062 */
            pr_default.execute(0, new Object[] {A21AirportId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z24AirportName, T00062_A24AirportName[0]) != 0 ) || ( Z9CountryId != T00062_A9CountryId[0] ) || ( Z15CityId != T00062_A15CityId[0] ) )
            {
               if ( StringUtil.StrCmp(Z24AirportName, T00062_A24AirportName[0]) != 0 )
               {
                  GXUtil.WriteLog("airport:[seudo value changed for attri]"+"AirportName");
                  GXUtil.WriteLogRaw("Old: ",Z24AirportName);
                  GXUtil.WriteLogRaw("Current: ",T00062_A24AirportName[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {A24AirportName, A9CountryId, A15CityId});
                     A21AirportId = T000612_A21AirportId[0];
                     AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
                     pr_default.close(10);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(11, new Object[] {A24AirportName, A9CountryId, A15CityId, A21AirportId});
                     pr_default.close(11);
                     pr_default.SmartCacheProvider.SetUpdated("Airport");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(12, new Object[] {A21AirportId});
                  pr_default.close(12);
                  pr_default.SmartCacheProvider.SetUpdated("Airport");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls067( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(14, new Object[] {A9CountryId, A15CityId});
            A16CityName = T000616_A16CityName[0];
            AssignAttri("", false, "A16CityName", A16CityName);
            pr_default.close(14);
         }
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(15, new Object[] {A21AirportId});
            if ( (pr_default.getStatus(15) != 101) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_del", new   object[]  {"Flyght"+" ("+"Flyght Arrival Airport"+")"}), "CannotDeleteReferencedRecord", 1, "");
               AnyError = 1;
            }
            pr_default.close(15);
            /* Using cursor T000618 */
            pr_default.execute(16, new Object[] {A21AirportId});
            if ( (pr_default.getStatus(16) != 101) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_del", new   object[]  {"Flyght"+" ("+"Flyght Departure Airport"+")"}), "CannotDeleteReferencedRecord", 1, "");
               AnyError = 1;
            }
            pr_default.close(16);
         }
      ...
      public void ScanStart067( )
      {
         ...
         {
            RcdFound7 = 1;
            A21AirportId = T000619_A21AirportId[0];
            AssignAttri("", false, "A21AirportId", StringUtil.LTrimStr( (decimal)(A21AirportId), 4, 0));
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z21AirportId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z21AirportId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z24AirportName", StringUtil.RTrim( Z24AirportName));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245291695842", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("airport.js", "?20245291695842", false, true);
      ...
      public void Valid_Airportid( )
      {
         ...
         AssignAttri("", false, "A24AirportName", StringUtil.RTrim( A24AirportName));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_AIRPORTID","""{"handler":"Valid_Airportid","iparms":[{"av":"A21AirportId","fld":"AIRPORTID","pic":"ZZZ9"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]""");
         setEventMetadata("VALID_AIRPORTID",""","oparms":[{"av":"A24AirportName","fld":"AIRPORTNAME"},{"av":"A9CountryId","fld":"COUNTRYID","pic":"ZZZ9"},{"av":"A15CityId","fld":"CITYID","pic":"ZZZ9"},{"av":"A10CountryName","fld":"COUNTRYNAME"},{"av":"A16CityName","fld":"CITYNAME"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z21AirportId"},{"av":"Z24AirportName"},{"av":"Z9CountryId"},{"av":"Z15CityId"},{"av":"Z10CountryName"},{"av":"Z16CityName"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
      ...
      public override void initialize( )
      {
         ...
         Z10CountryName = "";
         Z16CityName = "";
         T00066_A21AirportId = new short[1] ;
         T00066_A24AirportName = new string[] {""} ;
         T00066_A10CountryName = new string[] {""} ;
         T00066_A16CityName = new string[] {""} ;
         T00066_A9CountryId = new short[1] ;
         T00066_A15CityId = new short[1] ;
         T00064_A10CountryName = new string[] {""} ;
         T00065_A16CityName = new string[] {""} ;
         T00067_A10CountryName = new string[] {""} ;
         T00068_A16CityName = new string[] {""} ;
         T00069_A21AirportId = new short[1] ;
         T00063_A21AirportId = new short[1] ;
         T00063_A24AirportName = new string[] {""} ;
         T00063_A9CountryId = new short[1] ;
         T00063_A15CityId = new short[1] ;
         sMode7 = "";
         T000610_A21AirportId = new short[1] ;
         T000611_A21AirportId = new short[1] ;
         T00062_A21AirportId = new short[1] ;
         T00062_A24AirportName = new string[] {""} ;
         T00062_A9CountryId = new short[1] ;
         T00062_A15CityId = new short[1] ;
         T000612_A21AirportId = new short[1] ;
         T000615_A10CountryName = new string[] {""} ;
         T000616_A16CityName = new string[] {""} ;
         T000617_A20FlyghtId = new short[1] ;
         T000618_A20FlyghtId = new short[1] ;
         T000619_A21AirportId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ24AirportName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.airport__default(),
            new Object[][] {
                new Object[] {
               T00062_A21AirportId, T00062_A24AirportName, T00062_A9CountryId, T00062_A15CityId
               }
               , new Object[] {
               T00063_A21AirportId, T00063_A24AirportName, T00063_A9CountryId, T00063_A15CityId
               }
               , new Object[] {
               ...
               , new Object[] {
               T00066_A21AirportId, T00066_A24AirportName, T00066_A10CountryName, T00066_A16CityName, T00066_A9CountryId, T00066_A15CityId
               }
               , new Object[] {
               ...
               , new Object[] {
               T000610_A21AirportId
               }
               , new Object[] {
               T000611_A21AirportId
               }
               , new Object[] {
               T000612_A21AirportId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T000619_A21AirportId
               }
            }
         );
      }

      private short Z21AirportId ;
      ...
      private string ZZ24AirportName ;
      ...
      private short[] T00066_A21AirportId ;
      private string[] T00066_A24AirportName ;
      private string[] T00066_A10CountryName ;
      private string[] T00066_A16CityName ;
      private short[] T00066_A9CountryId ;
      private short[] T00066_A15CityId ;
      private string[] T00064_A10CountryName ;
      private string[] T00065_A16CityName ;
      private string[] T00067_A10CountryName ;
      private string[] T00068_A16CityName ;
      private short[] T00069_A21AirportId ;
      private short[] T00063_A21AirportId ;
      private string[] T00063_A24AirportName ;
      private short[] T00063_A9CountryId ;
      private short[] T00063_A15CityId ;
      private short[] T000610_A21AirportId ;
      private short[] T000611_A21AirportId ;
      private short[] T00062_A21AirportId ;
      private string[] T00062_A24AirportName ;
      private short[] T00062_A9CountryId ;
      private short[] T00062_A15CityId ;
      private short[] T000612_A21AirportId ;
      private string[] T000615_A10CountryName ;
      private string[] T000616_A16CityName ;
      private short[] T000617_A20FlyghtId ;
      private short[] T000618_A20FlyghtId ;
      private short[] T000619_A21AirportId ;
   }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T000617", "SELECT TOP 1 [FlyghtId] FROM [Flyght] WHERE [FlyghtArrivalAirportId] = @AirportId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000617,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000618", "SELECT TOP 1 [FlyghtId] FROM [Flyght] WHERE [FlyghtDepartureAirportId] = @AirportId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000618,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000619", "SELECT [AirportId] FROM [Airport] ORDER BY [AirportId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000619,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
