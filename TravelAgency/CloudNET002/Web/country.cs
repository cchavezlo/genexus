...
namespace GeneXus.Programs {
   public class country : GXDataArea
   {
      ...
      protected void gxnrGridcountry_city_newrow_invoke( )
      {
         ...
         A19CountryLastLine = (short)(Math.Round(NumberUtil.Val( GetPar( "CountryLastLine"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCountryLastLine_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A19CountryLastLine), 4, 0, ".", "")), StringUtil.LTrim( ((edtCountryLastLine_Enabled!=0) ? context.localUtil.Format( (decimal)(A19CountryLastLine), "ZZZ9") : context.localUtil.Format( (decimal)(A19CountryLastLine), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryLastLine_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryLastLine_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Country.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxdraw_Gridcountry_city( )
      {
         ...
         else if ( ( nKeyPressed == 3 ) || ( nKeyPressed == 4 ) || ( ( nKeyPressed == 1 ) && ( AnyError != 0 ) ) )
         {
            ...
            B19CountryLastLine = A19CountryLastLine;
            AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
            ...
            Gx_mode = sMode5;
            AssignAttri("", false, "Gx_mode", Gx_mode);
            A19CountryLastLine = B19CountryLastLine;
            AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
         }
         else
         {
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z19CountryLastLine = (short)(Math.Round(context.localUtil.CToN( cgiGet( "Z19CountryLastLine"), ".", ","), 18, MidpointRounding.ToEven));
               O19CountryLastLine = (short)(Math.Round(context.localUtil.CToN( cgiGet( "O19CountryLastLine"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               A19CountryLastLine = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtCountryLastLine_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
      ...
      {
         s19CountryLastLine = O19CountryLastLine;
         AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
         nGXsfl_53_idx = 0;
         while ( nGXsfl_53_idx < nRC_GXsfl_53 )
         {
               ...
               if ( ( nRcdExists_5 == 0 ) && ( nRcdDeleted_5 == 0 ) )
               {
                  if ( RcdFound5 == 0 )
                  {
                     ...
                     if ( AnyError == 0 )
                     {
                        ...
                        O19CountryLastLine = A19CountryLastLine;
                        AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
                     }
                  }
                  else
            ...
            ChangePostValue( edtCityId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CityId), 4, 0, ".", ""))) ;
            ChangePostValue( edtCityName_Internalname, StringUtil.RTrim( A16CityName)) ;
            ChangePostValue( "ZT_"+"Z15CityId_"+sGXsfl_53_idx, StringUtil.LTrim( StringUtil.NToC( (decimal)(Z15CityId), 4, 0, ".", ""))) ;
            ChangePostValue( "ZT_"+"Z16CityName_"+sGXsfl_53_idx, StringUtil.RTrim( Z16CityName)) ;
         ...
         O19CountryLastLine = s19CountryLastLine;
         AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
      ...
      protected void ZM033( short GX_JID )
      {
         if ( ( GX_JID == 7 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z19CountryLastLine = T00035_A19CountryLastLine[0];
            }
            else
            {
               Z10CountryName = A10CountryName;
               Z19CountryLastLine = A19CountryLastLine;
            }
         }
         if ( GX_JID == -7 )
         {
      ...
      {
         /* Using cursor T00036 */
         pr_default.execute(4, new Object[] {n9CountryId, A9CountryId});
         if ( (pr_default.getStatus(4) != 101) )
         {
            RcdFound3 = 1;
            A10CountryName = T00036_A10CountryName[0];
            AssignAttri("", false, "A10CountryName", A10CountryName);
            A19CountryLastLine = T00036_A19CountryLastLine[0];
            AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
            ZM033( -7) ;
         }
         pr_default.close(4);
      ...
      {
         /* Using cursor T00037 */
         pr_default.execute(5, new Object[] {n9CountryId, A9CountryId});
      ...
      {
         /* Using cursor T00035 */
         pr_default.execute(3, new Object[] {n9CountryId, A9CountryId});
         if ( (pr_default.getStatus(3) != 101) )
         {
            ZM033( 7) ;
            RcdFound3 = 1;
            A9CountryId = T00035_A9CountryId[0];
            n9CountryId = T00035_n9CountryId[0];
            AssignAttri("", false, "A9CountryId", StringUtil.LTrimStr( (decimal)(A9CountryId), 4, 0));
            A10CountryName = T00035_A10CountryName[0];
            AssignAttri("", false, "A10CountryName", A10CountryName);
            A19CountryLastLine = T00035_A19CountryLastLine[0];
            AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
            O19CountryLastLine = A19CountryLastLine;
            AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
            Z9CountryId = A9CountryId;
      ...
      protected void move_next( )
      {
         RcdFound3 = 0;
         /* Using cursor T00038 */
         pr_default.execute(6, new Object[] {n9CountryId, A9CountryId});
         if ( (pr_default.getStatus(6) != 101) )
         {
            ...
            if ( (pr_default.getStatus(6) != 101) && ( ( T00038_A9CountryId[0] > A9CountryId ) ) )
            {
               ...
               n9CountryId = T00038_n9CountryId[0];
               AssignAttri("", false, "A9CountryId", StringUtil.LTrimStr( (decimal)(A9CountryId), 4, 0));
               RcdFound3 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         if ( (pr_default.getStatus(7) != 101) )
         {
            ...
            if ( (pr_default.getStatus(7) != 101) && ( ( T00039_A9CountryId[0] < A9CountryId ) ) )
            {
               ...
               n9CountryId = T00039_n9CountryId[0];
               AssignAttri("", false, "A9CountryId", StringUtil.LTrimStr( (decimal)(A9CountryId), 4, 0));
               RcdFound3 = 1;
            }
         }
      ...
      protected void btn_enter( )
      {
         ...
         {
            /* Insert record */
            A19CountryLastLine = O19CountryLastLine;
            AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
            GX_FocusControl = edtCountryName_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
            Insert033( ) ;
      ...
      protected void CheckOptimisticConcurrency033( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(2) == 101) || ( StringUtil.StrCmp(Z10CountryName, T00034_A10CountryName[0]) != 0 ) || ( Z19CountryLastLine != T00034_A19CountryLastLine[0] ) )
            {
               ...
               if ( Z19CountryLastLine != T00034_A19CountryLastLine[0] )
               {
                  GXUtil.WriteLog("country:[seudo value changed for attri]"+"CountryLastLine");
                  GXUtil.WriteLogRaw("Old: ",Z19CountryLastLine);
                  GXUtil.WriteLogRaw("Current: ",T00034_A19CountryLastLine[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A10CountryName, A19CountryLastLine});
                     A9CountryId = T000310_A9CountryId[0];
                     n9CountryId = T000310_n9CountryId[0];
                     AssignAttri("", false, "A9CountryId", StringUtil.LTrimStr( (decimal)(A9CountryId), 4, 0));
                     pr_default.close(8);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A10CountryName, A19CountryLastLine, n9CountryId, A9CountryId});
                     pr_default.close(9);
                     pr_default.SmartCacheProvider.SetUpdated("Country");
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {n9CountryId, A9CountryId});
                     pr_default.close(10);
                     pr_default.SmartCacheProvider.SetUpdated("Country");
                     if ( AnyError == 0 )
                     {
      ...
      protected void OnDeleteControls033( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(11, new Object[] {n9CountryId, A9CountryId});
      ...
      protected void ProcessLevel033( )
      {
         ...
         pr_default.execute(12, new Object[] {A19CountryLastLine, n9CountryId, A9CountryId});
         pr_default.close(12);
         pr_default.SmartCacheProvider.SetUpdated("Country");
      }
      ...
      public void ScanStart033( )
      {
         ...
         if ( (pr_default.getStatus(13) != 101) )
         {
            ...
            n9CountryId = T000315_n9CountryId[0];
            AssignAttri("", false, "A9CountryId", StringUtil.LTrimStr( (decimal)(A9CountryId), 4, 0));
         }
      ...
      protected void ZM035( short GX_JID )
      {
         if ( ( GX_JID == 8 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z16CityName = T00033_A16CityName[0];
            }
            else
            {
      ...
      protected void standaloneModal035( )
      {
         if ( IsIns( )  )
         {
            A19CountryLastLine = (short)(O19CountryLastLine+1);
            AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
         }
         if ( IsIns( )  && ( Gx_BScreen == 1 ) )
         {
            A15CityId = A19CountryLastLine;
            n15CityId = false;
         }
      ...
      protected void Load035( )
      {
         ...
         pr_default.execute(14, new Object[] {n9CountryId, A9CountryId, n15CityId, A15CityId});
         if ( (pr_default.getStatus(14) != 101) )
         {
            RcdFound5 = 1;
            A16CityName = T000316_A16CityName[0];
            ZM035( -8) ;
         }
         pr_default.close(14);
         OnLoadActions035( ) ;
      ...
      protected void GetKey035( )
      {
         ...
         pr_default.execute(15, new Object[] {n9CountryId, A9CountryId, n15CityId, A15CityId});
      ...
      {
         /* Using cursor T00033 */
         pr_default.execute(1, new Object[] {n9CountryId, A9CountryId, n15CityId, A15CityId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM035( 8) ;
            RcdFound5 = 1;
            InitializeNonKey035( ) ;
            A15CityId = T00033_A15CityId[0];
            n15CityId = T00033_n15CityId[0];
            A16CityName = T00033_A16CityName[0];
            Z9CountryId = A9CountryId;
            Z15CityId = A15CityId;
            sMode5 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void CheckOptimisticConcurrency035( )
      {
         ...
         {
            /* Using cursor T00032 */
            pr_default.execute(0, new Object[] {n9CountryId, A9CountryId, n15CityId, A15CityId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z16CityName, T00032_A16CityName[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z16CityName, T00032_A16CityName[0]) != 0 )
               {
                  GXUtil.WriteLog("country:[seudo value changed for attri]"+"CityName");
                  GXUtil.WriteLogRaw("Old: ",Z16CityName);
                  GXUtil.WriteLogRaw("Current: ",T00032_A16CityName[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(16, new Object[] {n9CountryId, A9CountryId, n15CityId, A15CityId, A16CityName});
                     pr_default.close(16);
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     if ( AnyError == 0 )
                     {
                        ...
                        pr_default.execute(17, new Object[] {A16CityName, n9CountryId, A9CountryId, n15CityId, A15CityId});
                        pr_default.close(17);
                        pr_default.SmartCacheProvider.SetUpdated("CountryCity");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(18, new Object[] {n9CountryId, A9CountryId, n15CityId, A15CityId});
                  pr_default.close(18);
                  pr_default.SmartCacheProvider.SetUpdated("CountryCity");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls035( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(20, new Object[] {n9CountryId, A9CountryId, n15CityId, A15CityId});
      ...
      public void ScanStart035( )
      {
         ...
         pr_default.execute(21, new Object[] {n9CountryId, A9CountryId});
         RcdFound5 = 0;
         if ( (pr_default.getStatus(21) != 101) )
         {
            RcdFound5 = 1;
            A15CityId = T000323_A15CityId[0];
            n15CityId = T000323_n15CityId[0];
         }
         /* Load Subordinate Levels */
      }
      ...
      protected void SendRow035( )
      {
         ...
         Gridcountry_cityRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCityId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CityId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A15CityId), "ZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,54);\"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCityId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtCityId_Enabled,(short)1,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)53,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
         /* Subfile cell */
         /* Single line edit */
      ...
      protected void ReadRow035( )
      {
         ...
         GXCCtl = "Z15CityId_" + sGXsfl_53_idx;
         Z15CityId = (short)(Math.Round(context.localUtil.CToN( cgiGet( GXCCtl), ".", ","), 18, MidpointRounding.ToEven));
         GXCCtl = "Z16CityName_" + sGXsfl_53_idx;
         Z16CityName = cgiGet( GXCCtl);
         GXCCtl = "nRcdDeleted_5_" + sGXsfl_53_idx;
      ...
      protected void ConfirmValues030( )
      {
         ...
         while ( nGXsfl_53_idx < nRC_GXsfl_53 )
         {
            ...
            sGXsfl_53_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_53_idx), 4, 0), 4, "0");
            SubsflControlProps_535( ) ;
            ChangePostValue( "Z15CityId_"+sGXsfl_53_idx, cgiGet( "ZT_"+"Z15CityId_"+sGXsfl_53_idx)) ;
            DeletePostValue( "ZT_"+"Z15CityId_"+sGXsfl_53_idx) ;
            ChangePostValue( "Z16CityName_"+sGXsfl_53_idx, cgiGet( "ZT_"+"Z16CityName_"+sGXsfl_53_idx)) ;
            DeletePostValue( "ZT_"+"Z16CityName_"+sGXsfl_53_idx) ;
         }
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z19CountryLastLine", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z19CountryLastLine), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "O19CountryLastLine", StringUtil.LTrim( StringUtil.NToC( (decimal)(O19CountryLastLine), 4, 0, ".", "")));
      ...
      protected void InitializeNonKey033( )
      {
         A10CountryName = "";
         AssignAttri("", false, "A10CountryName", A10CountryName);
         A19CountryLastLine = 0;
         AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
         O19CountryLastLine = A19CountryLastLine;
         AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
         Z10CountryName = "";
         Z19CountryLastLine = 0;
      }
      ...
      {
         A19CountryLastLine = i19CountryLastLine;
         AssignAttri("", false, "A19CountryLastLine", StringUtil.LTrimStr( (decimal)(A19CountryLastLine), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024530924380", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("country.js", "?2024530924381", false, true);
      ...
      protected void StartGridControl53( )
      {
         ...
         Gridcountry_cityColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CityId), 4, 0, ".", ""))));
         ...
         Gridcountry_cityColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         Gridcountry_cityColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A16CityName)));
      ...
      public override void initialize( )
      {
         ...
         T00036_n9CountryId = new bool[] {false} ;
         T00036_A10CountryName = new string[] {""} ;
         T00036_A19CountryLastLine = new short[1] ;
         T00037_A9CountryId = new short[1] ;
         T00037_n9CountryId = new bool[] {false} ;
         T00035_A9CountryId = new short[1] ;
         T00035_n9CountryId = new bool[] {false} ;
         T00035_A10CountryName = new string[] {""} ;
         T00035_A19CountryLastLine = new short[1] ;
         T00038_A9CountryId = new short[1] ;
         T00038_n9CountryId = new bool[] {false} ;
         T00039_A9CountryId = new short[1] ;
         T00039_n9CountryId = new bool[] {false} ;
         T00034_A9CountryId = new short[1] ;
         T00034_n9CountryId = new bool[] {false} ;
         T00034_A10CountryName = new string[] {""} ;
         T00034_A19CountryLastLine = new short[1] ;
         T000310_A9CountryId = new short[1] ;
         T000310_n9CountryId = new bool[] {false} ;
         T000313_A7AttractionId = new short[1] ;
         T000315_A9CountryId = new short[1] ;
         T000315_n9CountryId = new bool[] {false} ;
         T000316_A9CountryId = new short[1] ;
         T000316_n9CountryId = new bool[] {false} ;
         T000316_A15CityId = new short[1] ;
         T000316_n15CityId = new bool[] {false} ;
         T000316_A16CityName = new string[] {""} ;
         T000317_A9CountryId = new short[1] ;
         T000317_n9CountryId = new bool[] {false} ;
         T000317_A15CityId = new short[1] ;
         T000317_n15CityId = new bool[] {false} ;
         T00033_A9CountryId = new short[1] ;
         T00033_n9CountryId = new bool[] {false} ;
         T00033_A15CityId = new short[1] ;
         T00033_n15CityId = new bool[] {false} ;
         T00033_A16CityName = new string[] {""} ;
         T00032_A9CountryId = new short[1] ;
         T00032_n9CountryId = new bool[] {false} ;
         T00032_A15CityId = new short[1] ;
         T00032_n15CityId = new bool[] {false} ;
         T00032_A16CityName = new string[] {""} ;
         T000321_A21AirportId = new short[1] ;
         T000322_A7AttractionId = new short[1] ;
         T000323_A9CountryId = new short[1] ;
         T000323_n9CountryId = new bool[] {false} ;
         T000323_A15CityId = new short[1] ;
         T000323_n15CityId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.country__default(),
            new Object[][] {
                new Object[] {
               T00032_A9CountryId, T00032_A15CityId, T00032_A16CityName
               }
               , new Object[] {
               T00033_A9CountryId, T00033_A15CityId, T00033_A16CityName
               }
               , new Object[] {
               T00034_A9CountryId, T00034_A10CountryName, T00034_A19CountryLastLine
               }
               , new Object[] {
               T00035_A9CountryId, T00035_A10CountryName, T00035_A19CountryLastLine
               }
               , new Object[] {
               T00036_A9CountryId, T00036_A10CountryName, T00036_A19CountryLastLine
               }
               , new Object[] {
               T00037_A9CountryId
               }
               ...
               , new Object[] {
               T000316_A9CountryId, T000316_A15CityId, T000316_A16CityName
               }
               , new Object[] {
               T000317_A9CountryId, T000317_A15CityId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T000321_A21AirportId
               }
               , new Object[] {
               T000322_A7AttractionId
               }
               , new Object[] {
               T000323_A9CountryId, T000323_A15CityId
               }
            }
         );
         AV12Pgmname = "Country";
      ...
      private short Z19CountryLastLine ;
      private short O19CountryLastLine ;
      ...
      private short A19CountryLastLine ;
      private short Gx_BScreen ;
      private short A9CountryId ;
      private short nBlankRcdCount5 ;
      private short RcdFound5 ;
      private short B19CountryLastLine ;
      private short nBlankRcdUsr5 ;
      private short RcdFound3 ;
      private short s19CountryLastLine ;
      ...
      private short i19CountryLastLine ;
      ...
      private bool[] T00036_n9CountryId ;
      private string[] T00036_A10CountryName ;
      private short[] T00036_A19CountryLastLine ;
      private short[] T00037_A9CountryId ;
      private bool[] T00037_n9CountryId ;
      private short[] T00035_A9CountryId ;
      private bool[] T00035_n9CountryId ;
      private string[] T00035_A10CountryName ;
      private short[] T00035_A19CountryLastLine ;
      private short[] T00038_A9CountryId ;
      private bool[] T00038_n9CountryId ;
      private short[] T00039_A9CountryId ;
      private bool[] T00039_n9CountryId ;
      private short[] T00034_A9CountryId ;
      private bool[] T00034_n9CountryId ;
      private string[] T00034_A10CountryName ;
      private short[] T00034_A19CountryLastLine ;
      private short[] T000310_A9CountryId ;
      private bool[] T000310_n9CountryId ;
      private short[] T000313_A7AttractionId ;
      private short[] T000315_A9CountryId ;
      private bool[] T000315_n9CountryId ;
      private short[] T000316_A9CountryId ;
      private bool[] T000316_n9CountryId ;
      private short[] T000316_A15CityId ;
      private bool[] T000316_n15CityId ;
      private string[] T000316_A16CityName ;
      private short[] T000317_A9CountryId ;
      private bool[] T000317_n9CountryId ;
      private short[] T000317_A15CityId ;
      private bool[] T000317_n15CityId ;
      private short[] T00033_A9CountryId ;
      private bool[] T00033_n9CountryId ;
      private short[] T00033_A15CityId ;
      private bool[] T00033_n15CityId ;
      private string[] T00033_A16CityName ;
      private short[] T00032_A9CountryId ;
      private bool[] T00032_n9CountryId ;
      private short[] T00032_A15CityId ;
      private bool[] T00032_n15CityId ;
      private string[] T00032_A16CityName ;
      private short[] T000321_A21AirportId ;
      private short[] T000322_A7AttractionId ;
      private short[] T000323_A9CountryId ;
      private bool[] T000323_n9CountryId ;
      private short[] T000323_A15CityId ;
      private bool[] T000323_n15CityId ;
   }
