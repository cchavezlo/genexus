...
namespace GeneXus.Programs {
   public class gx0010 : GXDataArea
   {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cCustomerId, AV7cCustomerName, AV8cCustomerLastName, AV9cCustomerPhone, AV13cCustomerAddedDate) ;
      ...
      protected void WB030( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcustomeraddeddate_Internalname, context.localUtil.Format(AV13cCustomerAddedDate, "99/99/99"), context.localUtil.Format( AV13cCustomerAddedDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcustomeraddeddate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCcustomeraddeddate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0010.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e15031_client"+"'", TempTags, "", 2, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              A17CustomerAddedDate = DateTimeUtil.ResetTime(context.localUtil.CToT( cgiGet( edtCustomerAddedDate_Internalname), 0));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void RF032( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00032 */
            pr_default.execute(0, new Object[] {AV6cCustomerId, lV7cCustomerName, lV8cCustomerLastName, lV9cCustomerPhone, AV13cCustomerAddedDate, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_64_idx = 1;
            sGXsfl_64_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_64_idx), 4, 0), 4, "0");
            SubsflControlProps_642( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A17CustomerAddedDate = H00032_A17CustomerAddedDate[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CUSTOMERID"+"_"+sGXsfl_64_idx, GetSecureSignedToken( sGXsfl_64_idx, context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV9cCustomerPhone = StringUtil.PadR( StringUtil.RTrim( AV9cCustomerPhone), 20, "%");
         /* Using cursor H00033 */
         pr_default.execute(1, new Object[] {AV6cCustomerId, lV7cCustomerName, lV8cCustomerLastName, lV9cCustomerPhone, AV13cCustomerAddedDate});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtCustomerId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerId_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtCustomerName_Enabled = 0;
         AssignProp("", false, edtCustomerName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerName_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtCustomerLastName_Enabled = 0;
         AssignProp("", false, edtCustomerLastName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerLastName_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtCustomerPhone_Enabled = 0;
         AssignProp("", false, edtCustomerPhone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerPhone_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtCustomerAddedDate_Enabled = 0;
         AssignProp("", false, edtCustomerAddedDate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerAddedDate_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245291021475", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0010.js", "?20245291021475", false, true);
      ...
      protected void SubsflControlProps_642( )
      {
         ...
         edtCustomerLastName_Internalname = "CUSTOMERLASTNAME_"+sGXsfl_64_idx;
         edtCustomerPhone_Internalname = "CUSTOMERPHONE_"+sGXsfl_64_idx;
         edtCustomerAddedDate_Internalname = "CUSTOMERADDEDDATE_"+sGXsfl_64_idx;
      }
      ...
      protected void SubsflControlProps_fel_642( )
      {
         ...
         edtCustomerLastName_Internalname = "CUSTOMERLASTNAME_"+sGXsfl_64_fel_idx;
         edtCustomerPhone_Internalname = "CUSTOMERPHONE_"+sGXsfl_64_fel_idx;
         edtCustomerAddedDate_Internalname = "CUSTOMERADDEDDATE_"+sGXsfl_64_fel_idx;
      }
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerAddedDate_Internalname,context.localUtil.Format(A17CustomerAddedDate, "99/99/99"),context.localUtil.Format( A17CustomerAddedDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerAddedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)64,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl64( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A17CustomerAddedDate, "99/99/99")));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E18032","iparms":[{"av":"A1CustomerId","fld":"CUSTOMERID","pic":"ZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         lV9cCustomerPhone = "";
         H00032_A17CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0010__default(),
            new Object[][] {
                new Object[] {
               H00032_A17CustomerAddedDate, H00032_A5CustomerPhone, H00032_A3CustomerLastName, H00032_A2CustomerName, H00032_A1CustomerId
               }
               , new Object[] {
      ...
      private DateTime[] H00032_A17CustomerAddedDate ;
   ...
   public class gx0010__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cCustomerId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [CustomerAddedDate], [CustomerPhone], [CustomerLastName], [CustomerName], [CustomerId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00032(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H00033(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (short)dynConstraints[8] );
         }
