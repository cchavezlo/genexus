   ...
   public class aattractionlist : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "CoutryId");
            if ( ! entryPointCalled )
            {
               AV8CoutryId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
            }
         }
         if ( GxWebError == 0 )
         {
      ...
      public void execute( short aP0_CoutryId )
      {
         this.AV8CoutryId = aP0_CoutryId;
         initialize();
         ExecuteImpl();
      }

      public void executeSubmit( short aP0_CoutryId )
      {
         this.AV8CoutryId = aP0_CoutryId;
         SubmitImpl();
      }
      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            /* Using cursor P000F2 */
            pr_default.execute(0, new Object[] {AV8CoutryId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A9CountryId = P000F2_A9CountryId[0];
               n9CountryId = P000F2_n9CountryId[0];
               A40000AttractionFoto_GXI = P000F2_A40000AttractionFoto_GXI[0];
               A8AttractionName = P000F2_A8AttractionName[0];
               A7AttractionId = P000F2_A7AttractionId[0];
               A10CountryName = P000F2_A10CountryName[0];
               A14AttractionFoto = P000F2_A14AttractionFoto[0];
               A10CountryName = P000F2_A10CountryName[0];
               H0F0( false, 100) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
      ...
      public override void initialize( )
      {
         ...
         P000F2_n9CountryId = new bool[] {false} ;
         P000F2_A40000AttractionFoto_GXI = new string[] {""} ;
         P000F2_A8AttractionName = new string[] {""} ;
         P000F2_A7AttractionId = new short[1] ;
         P000F2_A10CountryName = new string[] {""} ;
         P000F2_A14AttractionFoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aattractionlist__default(),
            new Object[][] {
                new Object[] {
               P000F2_A9CountryId, P000F2_n9CountryId, P000F2_A40000AttractionFoto_GXI, P000F2_A8AttractionName, P000F2_A7AttractionId, P000F2_A10CountryName, P000F2_A14AttractionFoto
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P000F2_n9CountryId ;
      private string[] P000F2_A40000AttractionFoto_GXI ;
      private string[] P000F2_A8AttractionName ;
      private short[] P000F2_A7AttractionId ;
      private string[] P000F2_A10CountryName ;
      private string[] P000F2_A14AttractionFoto ;
   }
   ...
   public class aattractionlist__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8CoutryId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("P000F2", "SELECT T1.[CountryId], T1.[AttractionFoto_GXI], T1.[AttractionName], T1.[AttractionId], T2.[CountryName], T1.[AttractionFoto] FROM ([Attraction] T1 LEFT JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) WHERE T1.[CountryId] = @AV8CoutryId ORDER BY T2.[CountryName] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000F2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
