...
namespace GeneXus.Programs {
   public class gx0020 : GXDataArea
   {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV11cCountryId = (short)(Math.Round(NumberUtil.Val( GetPar( "cCountryId"), "."), 18, MidpointRounding.ToEven));
         AV12cCategoryId = (short)(Math.Round(NumberUtil.Val( GetPar( "cCategoryId"), "."), 18, MidpointRounding.ToEven));
         AV13cCityId = (short)(Math.Round(NumberUtil.Val( GetPar( "cCityId"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cAttractionId, AV7cAttractionName, AV11cCountryId, AV12cCategoryId, AV13cCityId) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCCOUNTRYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cCountryId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGORYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cCategoryId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCCITYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13cCityId), 4, 0, ".", "")));
         /* Send saved values. */
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblattractionidfilter_Internalname, "Attraction Id", "", "", lblLblattractionidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11051_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblattractionnamefilter_Internalname, "Attraction Name", "", "", lblLblattractionnamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12051_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcountryidfilter_Internalname, "Country Id", "", "", lblLblcountryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13051_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcountryid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cCountryId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCcountryid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV11cCountryId), "ZZZ9") : context.localUtil.Format( (decimal)(AV11cCountryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcountryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcountryid_Visible, edtavCcountryid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategoryidfilter_Internalname, "Category Id", "", "", lblLblcategoryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14051_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategoryid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cCategoryId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCcategoryid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV12cCategoryId), "ZZZ9") : context.localUtil.Format( (decimal)(AV12cCategoryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoryid_Visible, edtavCcategoryid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcityidfilter_Internalname, "City Id", "", "", lblLblcityidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15051_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcityid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13cCityId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCcityid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV13cCityId), "ZZZ9") : context.localUtil.Format( (decimal)(AV13cCityId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcityid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcityid_Visible, edtavCcityid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e16051_client"+"'", TempTags, "", 2, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtAttractionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14AttractionFoto)) ? A40000AttractionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A14AttractionFoto))), !bGXsfl_64_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCCOUNTRYID"), ".", ",") != Convert.ToDecimal( AV11cCountryId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCCITYID"), ".", ",") != Convert.ToDecimal( AV13cCityId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF052( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV6cAttractionId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT
                                                 }
            });
            lV7cAttractionName = StringUtil.PadR( StringUtil.RTrim( AV7cAttractionName), 50, "%");
            /* Using cursor H00052 */
            pr_default.execute(0, new Object[] {AV6cAttractionId, lV7cAttractionName, AV11cCountryId, AV12cCategoryId, AV13cCityId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_64_idx = 1;
            sGXsfl_64_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_64_idx), 4, 0), 4, "0");
            SubsflControlProps_642( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A15CityId = H00052_A15CityId[0];
               n15CityId = H00052_n15CityId[0];
               A12CategoryId = H00052_A12CategoryId[0];
               n12CategoryId = H00052_n12CategoryId[0];
               A40000AttractionFoto_GXI = H00052_A40000AttractionFoto_GXI[0];
               AssignProp("", false, edtAttractionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14AttractionFoto)) ? A40000AttractionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A14AttractionFoto))), !bGXsfl_64_Refreshing);
               AssignProp("", false, edtAttractionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A14AttractionFoto), true);
               A9CountryId = H00052_A9CountryId[0];
               n9CountryId = H00052_n9CountryId[0];
               A8AttractionName = H00052_A8AttractionName[0];
               A7AttractionId = H00052_A7AttractionId[0];
               A14AttractionFoto = H00052_A14AttractionFoto[0];
               AssignProp("", false, edtAttractionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14AttractionFoto)) ? A40000AttractionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A14AttractionFoto))), !bGXsfl_64_Refreshing);
               AssignProp("", false, edtAttractionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A14AttractionFoto), true);
               /* Execute user event: Load */
               E18052 ();
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cAttractionName = StringUtil.PadR( StringUtil.RTrim( AV7cAttractionName), 50, "%");
         /* Using cursor H00053 */
         pr_default.execute(1, new Object[] {AV6cAttractionId, lV7cAttractionName, AV11cCountryId, AV12cCategoryId, AV13cCityId});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtAttractionId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAttractionId_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtAttractionName_Enabled = 0;
         AssignProp("", false, edtAttractionName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAttractionName_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtCountryId_Enabled = 0;
         AssignProp("", false, edtCountryId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCountryId_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtAttractionFoto_Enabled = 0;
         AssignProp("", false, edtAttractionFoto_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAttractionFoto_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtCategoryId_Enabled = 0;
         AssignProp("", false, edtCategoryId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCategoryId_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtCityId_Enabled = 0;
         AssignProp("", false, edtCityId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCityId_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP050( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCcountryid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCcountryid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV11cCountryId = 0;
               AssignAttri("", false, "AV11cCountryId", StringUtil.LTrimStr( (decimal)(AV11cCountryId), 4, 0));
            }
            else
            {
               AV11cCountryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCcountryid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV11cCountryId", StringUtil.LTrimStr( (decimal)(AV11cCountryId), 4, 0));
            }
            ...
            {
               AV12cCategoryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCcategoryid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12cCategoryId", StringUtil.LTrimStr( (decimal)(AV12cCategoryId), 4, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCcityid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCcityid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV13cCityId = 0;
               AssignAttri("", false, "AV13cCityId", StringUtil.LTrimStr( (decimal)(AV13cCityId), 4, 0));
            }
            else
            {
               AV13cCityId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCcityid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV13cCityId", StringUtil.LTrimStr( (decimal)(AV13cCityId), 4, 0));
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245299311822", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0020.js", "?20245299311822", false, true);
      ...
      protected void SubsflControlProps_642( )
      {
         ...
         edtAttractionFoto_Internalname = "ATTRACTIONFOTO_"+sGXsfl_64_idx;
      ...
      protected void SubsflControlProps_fel_642( )
      {
         ...
         edtAttractionFoto_Internalname = "ATTRACTIONFOTO_"+sGXsfl_64_fel_idx;
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtAttractionFoto_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn OptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A14AttractionFoto_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoryId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12CategoryId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A12CategoryId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoryId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)64,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl64( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", context.convertURL( A14AttractionFoto));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A12CategoryId), 4, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAttractionId","fld":"vCATTRACTIONID","pic":"ZZZ9"},{"av":"AV7cAttractionName","fld":"vCATTRACTIONNAME"},{"av":"AV11cCountryId","fld":"vCCOUNTRYID","pic":"ZZZ9"},{"av":"AV12cCategoryId","fld":"vCCATEGORYID","pic":"ZZZ9"},{"av":"AV13cCityId","fld":"vCCITYID","pic":"ZZZ9"}]}""");
         setEventMetadata("'TOGGLE'","""{"handler":"E16051","iparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]""");
         setEventMetadata("'TOGGLE'",""","oparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]}""");
         setEventMetadata("LBLATTRACTIONIDFILTER.CLICK","""{"handler":"E11051","iparms":[{"av":"divAttractionidfiltercontainer_Class","ctrl":"ATTRACTIONIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLATTRACTIONNAMEFILTER.CLICK","""{"handler":"E12051","iparms":[{"av":"divAttractionnamefiltercontainer_Class","ctrl":"ATTRACTIONNAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCOUNTRYIDFILTER.CLICK","""{"handler":"E13051","iparms":[{"av":"divCountryidfiltercontainer_Class","ctrl":"COUNTRYIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCATEGORYIDFILTER.CLICK","""{"handler":"E14051","iparms":[{"av":"divCategoryidfiltercontainer_Class","ctrl":"CATEGORYIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCITYIDFILTER.CLICK","""{"handler":"E15051","iparms":[{"av":"divCityidfiltercontainer_Class","ctrl":"CITYIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E19052","iparms":[{"av":"A7AttractionId","fld":"ATTRACTIONID","pic":"ZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         lV7cAttractionName = "";
         H00052_A15CityId = new short[1] ;
         H00052_n15CityId = new bool[] {false} ;
         H00052_A12CategoryId = new short[1] ;
         H00052_n12CategoryId = new bool[] {false} ;
         H00052_A40000AttractionFoto_GXI = new string[] {""} ;
         H00052_A9CountryId = new short[1] ;
         H00052_n9CountryId = new bool[] {false} ;
         H00052_A8AttractionName = new string[] {""} ;
         H00052_A7AttractionId = new short[1] ;
         H00052_A14AttractionFoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0020__default(),
            new Object[][] {
                new Object[] {
               H00052_A15CityId, H00052_n15CityId, H00052_A12CategoryId, H00052_n12CategoryId, H00052_A40000AttractionFoto_GXI, H00052_A9CountryId, H00052_n9CountryId, H00052_A8AttractionName, H00052_A7AttractionId, H00052_A14AttractionFoto
               }
               , new Object[] {
      ...
      private short AV11cCountryId ;
      private short AV12cCategoryId ;
      private short AV13cCityId ;
      ...
      private short[] H00052_A15CityId ;
      private bool[] H00052_n15CityId ;
      private short[] H00052_A12CategoryId ;
      private bool[] H00052_n12CategoryId ;
      private string[] H00052_A40000AttractionFoto_GXI ;
      private short[] H00052_A9CountryId ;
      private bool[] H00052_n9CountryId ;
      private string[] H00052_A8AttractionName ;
      private short[] H00052_A7AttractionId ;
      private string[] H00052_A14AttractionFoto ;
   ...
   public class gx0020__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cAttractionId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [CityId], [CategoryId], [AttractionFoto_GXI], [CountryId], [AttractionName], [AttractionId], [AttractionFoto]";
         ...
         if ( ! (0==AV11cCountryId) )
         {
            AddWhere(sWhereString, "([CountryId] >= @AV11cCountryId)");
         }
         else
         {
            GXv_int1[2] = 1;
         ...
         if ( ! (0==AV13cCityId) )
         {
            AddWhere(sWhereString, "([CityId] >= @AV13cCityId)");
         }
         else
         {
            GXv_int1[4] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00052(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H00053(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV11cCountryId",GXType.Int16,4,0) ,
          new ParDef("@AV12cCategoryId",GXType.Int16,4,0) ,
          new ParDef("@AV13cCityId",GXType.Int16,4,0) ,
