...
namespace GeneXus.Programs {
   public class wwattraction : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11AttractionName, AV15CountryName, AV14ADVANCED_LABEL_TEMPLATE, AV12Update, AV13Delete) ;
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(29), 2, 0)+","+"null"+");", "Show Filters", bttBtntoggle_Jsonclick, 7, bttBtntoggle_Tooltiptext, "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110e1_client"+"'", TempTags, "", 2, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 29 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggleontable_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(29), 2, 0)+","+"null"+");", "Hide Filters", bttBtntoggleontable_Jsonclick, 7, "Hide Filters", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110e1_client"+"'", TempTags, "", 2, "HLP_WWAttraction.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCountryname_Internalname, StringUtil.RTrim( AV15CountryName), StringUtil.RTrim( context.localUtil.Format( AV15CountryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,52);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCountryname_Jsonclick, 0, "attribute-combo", "", "", "", "", edtavCountryname_Visible, edtavCountryname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtAttractionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14AttractionFoto)) ? A40000AttractionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A14AttractionFoto))), !bGXsfl_29_Refreshing);
      ...
      protected void RF0E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15CityId = H000E2_A15CityId[0];
               n15CityId = H000E2_n15CityId[0];
               A12CategoryId = H000E2_A12CategoryId[0];
               n12CategoryId = H000E2_n12CategoryId[0];
               A9CountryId = H000E2_A9CountryId[0];
               n9CountryId = H000E2_n9CountryId[0];
               A16CityName = H000E2_A16CityName[0];
               A40000AttractionFoto_GXI = H000E2_A40000AttractionFoto_GXI[0];
               AssignProp("", false, edtAttractionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14AttractionFoto)) ? A40000AttractionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A14AttractionFoto))), !bGXsfl_29_Refreshing);
               AssignProp("", false, edtAttractionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A14AttractionFoto), true);
               A13CategoryName = H000E2_A13CategoryName[0];
               A10CountryName = H000E2_A10CountryName[0];
               A8AttractionName = H000E2_A8AttractionName[0];
               A7AttractionId = H000E2_A7AttractionId[0];
               A14AttractionFoto = H000E2_A14AttractionFoto[0];
               AssignProp("", false, edtAttractionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14AttractionFoto)) ? A40000AttractionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A14AttractionFoto))), !bGXsfl_29_Refreshing);
               AssignProp("", false, edtAttractionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A14AttractionFoto), true);
               A13CategoryName = H000E2_A13CategoryName[0];
               A10CountryName = H000E2_A10CountryName[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtAttractionId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAttractionId_Enabled), 5, 0), !bGXsfl_29_Refreshing);
         edtAttractionName_Enabled = 0;
         AssignProp("", false, edtAttractionName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAttractionName_Enabled), 5, 0), !bGXsfl_29_Refreshing);
         edtCountryName_Enabled = 0;
         AssignProp("", false, edtCountryName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCountryName_Enabled), 5, 0), !bGXsfl_29_Refreshing);
         edtCategoryName_Enabled = 0;
         AssignProp("", false, edtCategoryName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCategoryName_Enabled), 5, 0), !bGXsfl_29_Refreshing);
         edtAttractionFoto_Enabled = 0;
         AssignProp("", false, edtAttractionFoto_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAttractionFoto_Enabled), 5, 0), !bGXsfl_29_Refreshing);
         edtCityName_Enabled = 0;
         AssignProp("", false, edtCityName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCityName_Enabled), 5, 0), !bGXsfl_29_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245301428123", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwattraction.js", "?20245301428124", false, true);
      ...
      protected void SubsflControlProps_292( )
      {
         ...
         edtAttractionFoto_Internalname = "ATTRACTIONFOTO_"+sGXsfl_29_idx;
      ...
      protected void SubsflControlProps_fel_292( )
      {
         ...
         edtAttractionFoto_Internalname = "ATTRACTIONFOTO_"+sGXsfl_29_fel_idx;
      ...
      protected void sendrow_292( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_29_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoryName_Internalname,StringUtil.RTrim( A13CategoryName),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoryName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)0,(short)0,(short)29,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtAttractionFoto_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"column column-optional",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A14AttractionFoto_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl29( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A13CategoryName)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A14AttractionFoto));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A16CityName)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11AttractionName","fld":"vATTRACTIONNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"AV15CountryName","fld":"vCOUNTRYNAME"},{"av":"AV14ADVANCED_LABEL_TEMPLATE","fld":"vADVANCED_LABEL_TEMPLATE","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         lV11AttractionName = "";
         lV15CountryName = "";
         H000E2_A15CityId = new short[1] ;
         H000E2_n15CityId = new bool[] {false} ;
         H000E2_A12CategoryId = new short[1] ;
         H000E2_n12CategoryId = new bool[] {false} ;
         H000E2_A9CountryId = new short[1] ;
         H000E2_n9CountryId = new bool[] {false} ;
         H000E2_A16CityName = new string[] {""} ;
         H000E2_A40000AttractionFoto_GXI = new string[] {""} ;
         H000E2_A13CategoryName = new string[] {""} ;
         H000E2_A10CountryName = new string[] {""} ;
         H000E2_A8AttractionName = new string[] {""} ;
         H000E2_A7AttractionId = new short[1] ;
         H000E2_A14AttractionFoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwattraction__default(),
            new Object[][] {
                new Object[] {
               H000E2_A15CityId, H000E2_n15CityId, H000E2_A12CategoryId, H000E2_n12CategoryId, H000E2_A9CountryId, H000E2_n9CountryId, H000E2_A16CityName, H000E2_A40000AttractionFoto_GXI, H000E2_A13CategoryName, H000E2_A10CountryName,
               H000E2_A8AttractionName, H000E2_A7AttractionId, H000E2_A14AttractionFoto
               }
               , new Object[] {
      ...
      private short[] H000E2_A15CityId ;
      private bool[] H000E2_n15CityId ;
      private short[] H000E2_A12CategoryId ;
      private bool[] H000E2_n12CategoryId ;
      private short[] H000E2_A9CountryId ;
      private bool[] H000E2_n9CountryId ;
      private string[] H000E2_A16CityName ;
      private string[] H000E2_A40000AttractionFoto_GXI ;
      private string[] H000E2_A13CategoryName ;
      private string[] H000E2_A10CountryName ;
      private string[] H000E2_A8AttractionName ;
      private short[] H000E2_A7AttractionId ;
      private string[] H000E2_A14AttractionFoto ;
   ...
   public class wwattraction__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A10CountryName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[CityId], T1.[CategoryId], T1.[CountryId], T4.[CityName], T1.[AttractionFoto_GXI], T2.[CategoryName], T3.[CountryName], T1.[AttractionName], T1.[AttractionId], T1.[AttractionFoto]";
         sFromString = " FROM ((([Attraction] T1 LEFT JOIN [Category] T2 ON T2.[CategoryId] = T1.[CategoryId]) LEFT JOIN [Country] T3 ON T3.[CountryId] = T1.[CountryId]) LEFT JOIN [CountryCity] T4 ON T4.[CountryId] = T1.[CountryId] AND T4.[CityId] = T1.[CityId])";
         sOrderString = "";
                                             ...
                                             string A10CountryName )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((([Attraction] T1 LEFT JOIN [Category] T4 ON T4.[CategoryId] = T1.[CategoryId]) LEFT JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) LEFT JOIN [CountryCity] T3 ON T3.[CountryId] = T1.[CountryId] AND T3.[CityId] = T1.[CityId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11AttractionName)) )
         {
            AddWhere(sWhereString, "(T1.[AttractionName] like @lV11AttractionName)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000E2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
               case 1 :
                     return conditional_H000E3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
         }
