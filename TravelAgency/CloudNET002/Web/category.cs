...
namespace GeneXus.Programs {
   public class category : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCategoryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A12CategoryId), 4, 0, ".", "")), StringUtil.LTrim( ((edtCategoryId_Enabled!=0) ? context.localUtil.Format( (decimal)(A12CategoryId), "ZZZ9") : context.localUtil.Format( (decimal)(A12CategoryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCategoryName_Internalname, StringUtil.RTrim( A13CategoryName), StringUtil.RTrim( context.localUtil.Format( A13CategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z13CategoryName = cgiGet( "Z13CategoryName");
      ...
      protected void ZM044( short GX_JID )
      {
         if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z13CategoryName = T00043_A13CategoryName[0];
            }
            else
            {
      ...
      {
         /* Using cursor T00044 */
         pr_default.execute(2, new Object[] {A12CategoryId});
         if ( (pr_default.getStatus(2) != 101) )
         {
            RcdFound4 = 1;
            A13CategoryName = T00044_A13CategoryName[0];
            AssignAttri("", false, "A13CategoryName", A13CategoryName);
            ZM044( -1) ;
         }
         pr_default.close(2);
      ...
      {
         /* Using cursor T00045 */
         pr_default.execute(3, new Object[] {A12CategoryId});
      ...
      {
         /* Using cursor T00043 */
         pr_default.execute(1, new Object[] {A12CategoryId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM044( 1) ;
            RcdFound4 = 1;
            A12CategoryId = T00043_A12CategoryId[0];
            AssignAttri("", false, "A12CategoryId", StringUtil.LTrimStr( (decimal)(A12CategoryId), 4, 0));
            A13CategoryName = T00043_A13CategoryName[0];
            AssignAttri("", false, "A13CategoryName", A13CategoryName);
            Z12CategoryId = A12CategoryId;
            sMode4 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         RcdFound4 = 0;
         /* Using cursor T00046 */
         pr_default.execute(4, new Object[] {A12CategoryId});
         if ( (pr_default.getStatus(4) != 101) )
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( T00046_A12CategoryId[0] < A12CategoryId ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( T00046_A12CategoryId[0] > A12CategoryId ) ) )
            {
               A12CategoryId = T00046_A12CategoryId[0];
               AssignAttri("", false, "A12CategoryId", StringUtil.LTrimStr( (decimal)(A12CategoryId), 4, 0));
               RcdFound4 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound4 = 0;
         /* Using cursor T00047 */
         pr_default.execute(5, new Object[] {A12CategoryId});
         if ( (pr_default.getStatus(5) != 101) )
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T00047_A12CategoryId[0] > A12CategoryId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T00047_A12CategoryId[0] < A12CategoryId ) ) )
            {
               A12CategoryId = T00047_A12CategoryId[0];
               AssignAttri("", false, "A12CategoryId", StringUtil.LTrimStr( (decimal)(A12CategoryId), 4, 0));
               RcdFound4 = 1;
            }
         }
      ...
      protected void btn_enter( )
      {
         ...
         else
         {
            if ( RcdFound4 == 1 )
            {
               if ( A12CategoryId != Z12CategoryId )
               {
                  A12CategoryId = Z12CategoryId;
                  AssignAttri("", false, "A12CategoryId", StringUtil.LTrimStr( (decimal)(A12CategoryId), 4, 0));
      ...
      protected void CheckOptimisticConcurrency044( )
      {
         ...
         {
            /* Using cursor T00042 */
            pr_default.execute(0, new Object[] {A12CategoryId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z13CategoryName, T00042_A13CategoryName[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z13CategoryName, T00042_A13CategoryName[0]) != 0 )
               {
                  GXUtil.WriteLog("category:[seudo value changed for attri]"+"CategoryName");
                  GXUtil.WriteLogRaw("Old: ",Z13CategoryName);
                  GXUtil.WriteLogRaw("Current: ",T00042_A13CategoryName[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00048 */
                     pr_default.execute(6, new Object[] {A13CategoryName});
                     A12CategoryId = T00048_A12CategoryId[0];
                     AssignAttri("", false, "A12CategoryId", StringUtil.LTrimStr( (decimal)(A12CategoryId), 4, 0));
                     pr_default.close(6);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00049 */
                     pr_default.execute(7, new Object[] {A13CategoryName, A12CategoryId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Category");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {A12CategoryId});
                  pr_default.close(8);
                  pr_default.SmartCacheProvider.SetUpdated("Category");
                  if ( AnyError == 0 )
                  {
      ...
      public void ScanStart044( )
      {
         ...
         {
            RcdFound4 = 1;
            A12CategoryId = T000411_A12CategoryId[0];
            AssignAttri("", false, "A12CategoryId", StringUtil.LTrimStr( (decimal)(A12CategoryId), 4, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245298513264", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("category.js", "?20245298513264", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_CATEGORYID","""{"handler":"Valid_Categoryid","iparms":[{"av":"A12CategoryId","fld":"CATEGORYID","pic":"ZZZ9"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]""");
         setEventMetadata("VALID_CATEGORYID",""","oparms":[{"av":"A13CategoryName","fld":"CATEGORYNAME"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z12CategoryId"},{"av":"Z13CategoryName"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         endTrnMsgTxt = "";
         endTrnMsgCod = "";
         T00044_A12CategoryId = new short[1] ;
         T00044_A13CategoryName = new string[] {""} ;
         T00045_A12CategoryId = new short[1] ;
         T00043_A12CategoryId = new short[1] ;
         T00043_A13CategoryName = new string[] {""} ;
         sMode4 = "";
         T00046_A12CategoryId = new short[1] ;
         T00047_A12CategoryId = new short[1] ;
         T00042_A12CategoryId = new short[1] ;
         T00042_A13CategoryName = new string[] {""} ;
         T00048_A12CategoryId = new short[1] ;
         T000411_A12CategoryId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ13CategoryName = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.category__default(),
            new Object[][] {
                new Object[] {
               T00042_A12CategoryId, T00042_A13CategoryName
               }
               , new Object[] {
               T00043_A12CategoryId, T00043_A13CategoryName
               }
               , new Object[] {
               T00044_A12CategoryId, T00044_A13CategoryName
               }
               , new Object[] {
               T00045_A12CategoryId
               }
               , new Object[] {
               T00046_A12CategoryId
               }
               , new Object[] {
               T00047_A12CategoryId
               }
               , new Object[] {
               T00048_A12CategoryId
               }
               , new Object[] {
               }
               , new Object[] {
      ...
      private short[] T00044_A12CategoryId ;
      private string[] T00044_A13CategoryName ;
      private short[] T00045_A12CategoryId ;
      private short[] T00043_A12CategoryId ;
      private string[] T00043_A13CategoryName ;
      private short[] T00046_A12CategoryId ;
      private short[] T00047_A12CategoryId ;
      private short[] T00042_A12CategoryId ;
      private string[] T00042_A13CategoryName ;
      private short[] T00048_A12CategoryId ;
      private short[] T000411_A12CategoryId ;
   }
