...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateSuplierAttraction( )
      {
         string cmdBuffer = "";
         /* Indices for table SuplierAttraction */
         try
         {
            cmdBuffer=" CREATE TABLE [SuplierAttraction] ([SuplierId] smallint NOT NULL , [AttractionId] smallint NOT NULL , [SuplierAttractionDate] datetime NOT NULL , PRIMARY KEY([SuplierId], [AttractionId]))  "
            ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[SuplierAttraction]") ;
               cmdBuffer=" DROP TABLE [SuplierAttraction] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               {
                  DropTableConstraints( "[SuplierAttraction]") ;
                  cmdBuffer=" DROP VIEW [SuplierAttraction] "
                  ;
                  RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                  RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
                  RGZ.ExecuteStmt() ;
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[SuplierAttraction]") ;
                     cmdBuffer=" DROP FUNCTION [SuplierAttraction] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         ...
         try
         {
            cmdBuffer=" CREATE NONCLUSTERED INDEX [ISUPLIERATTRACTION1] ON [SuplierAttraction] ([AttractionId] ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX [ISUPLIERATTRACTION1] ON [SuplierAttraction] "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      {
         string cmdBuffer = "";
         /* Indices for table Suplier */
         try
         {
            cmdBuffer=" CREATE TABLE [Suplier] ([SuplierId] smallint NOT NULL IDENTITY(1,1), [SuplierName] nchar(50) NOT NULL , [SuplierAddress] nvarchar(1024) NOT NULL , PRIMARY KEY([SuplierId]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[Suplier]") ;
               cmdBuffer=" DROP TABLE [Suplier] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[Suplier]") ;
                     cmdBuffer=" DROP FUNCTION [Suplier] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                     RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
                     RGZ.ExecuteStmt() ;
      ...
      public void RISuplierAttractionSuplier( )
      {
         string cmdBuffer;
         try
         {
            cmdBuffer=" ALTER TABLE [SuplierAttraction] ADD CONSTRAINT [ISUPLIERATTRACTION2] FOREIGN KEY ([SuplierId]) REFERENCES [Suplier] ([SuplierId]) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE [SuplierAttraction] DROP CONSTRAINT [ISUPLIERATTRACTION2] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      public void RISuplierAttractionAttraction( )
      {
         string cmdBuffer;
         try
         {
            cmdBuffer=" ALTER TABLE [SuplierAttraction] ADD CONSTRAINT [ISUPLIERATTRACTION1] FOREIGN KEY ([AttractionId]) REFERENCES [Attraction] ([AttractionId]) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE [SuplierAttraction] DROP CONSTRAINT [ISUPLIERATTRACTION1] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("SuplierAttraction",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"SuplierAttraction"}) ) ;
            return false ;
         }
         if ( tableexist("Suplier",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"Suplier"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateSuplierAttraction" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateSuplier" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "RISuplierAttractionSuplier" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 4 ,  "RISuplierAttractionAttraction" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"SuplierAttraction", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateSuplierAttraction" ,  "CreateSuplier" );
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Suplier", ""}) );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"[ISUPLIERATTRACTION2]"}) );
         ReorgExecute.RegisterPrecedence( "RISuplierAttractionSuplier" ,  "CreateSuplierAttraction" );
         ReorgExecute.RegisterPrecedence( "RISuplierAttractionSuplier" ,  "CreateSuplier" );
         GXReorganization.SetMsg( 4 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"[ISUPLIERATTRACTION1]"}) );
         ReorgExecute.RegisterPrecedence( "RISuplierAttractionAttraction" ,  "CreateSuplierAttraction" );
      }
