...
namespace GeneXus.Programs {
   public class gx0090 : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0090.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pAirlineID,4,0))}, new string[] {"pAirlineID"}) +"\">") ;
      ...
      {
         return formatLink("gx0090.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pAirlineID,4,0))}, new string[] {"pAirlineID"})  ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblairlineidfilter_Internalname, "Airline ID", "", "", lblLblairlineidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110i1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0090.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCairlineid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cAirlineID), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCairlineid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cAirlineID), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cAirlineID), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCairlineid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCairlineid_Visible, edtavCairlineid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblairlinenamefilter_Internalname, "Airline Name", "", "", lblLblairlinenamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120i1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblairlinediscountpercentagefilter_Internalname, "Airline Discount Percentage", "", "", lblLblairlinediscountpercentagefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130i1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCairlinediscountpercentage_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cAirlineDiscountPercentage), 3, 0, ".", "")), StringUtil.LTrim( ((edtavCairlinediscountpercentage_Enabled!=0) ? context.localUtil.Format( (decimal)(AV8cAirlineDiscountPercentage), "ZZ9") : context.localUtil.Format( (decimal)(AV8cAirlineDiscountPercentage), "ZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCairlinediscountpercentage_Jsonclick, 0, "Attribute", "", "", "", "", edtavCairlinediscountpercentage_Visible, edtavCairlinediscountpercentage_Enabled, 0, "text", "1", 3, "chr", 1, "row", 3, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e140i1_client"+"'", TempTags, "", 2, "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_AIRLINEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A30AirlineID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "AIRLINEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A30AirlineID), 4, 0, ".", "")));
      }
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A32AirlineDiscountPercentage = H000I2_A32AirlineDiscountPercentage[0];
               A31AirlineName = H000I2_A31AirlineName[0];
               A30AirlineID = H000I2_A30AirlineID[0];
               /* Execute user event: Load */
               E160I2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_AIRLINEID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A30AirlineID), "ZZZ9"), context));
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtAirlineID_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAirlineID_Enabled), 5, 0), !bGXsfl_44_Refreshing);
         edtAirlineName_Enabled = 0;
         AssignProp("", false, edtAirlineName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAirlineName_Enabled), 5, 0), !bGXsfl_44_Refreshing);
         edtAirlineDiscountPercentage_Enabled = 0;
         AssignProp("", false, edtAirlineDiscountPercentage_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAirlineDiscountPercentage_Enabled), 5, 0), !bGXsfl_44_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245291615484", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0090.js", "?20245291615484", false, true);
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A30AirlineID), 4, 0, ".", "")))+"'"+"]);";
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAirlineDiscountPercentage_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A32AirlineDiscountPercentage), 3, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A32AirlineDiscountPercentage), "ZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAirlineDiscountPercentage_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)3,(short)0,(short)0,(short)44,(short)0,(short)-1,(short)0,(bool)true,(string)"Percentage",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl44( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A31AirlineName)));
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtAirlineName_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A32AirlineDiscountPercentage), 3, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E170I2","iparms":[{"av":"A30AirlineID","fld":"AIRLINEID","pic":"ZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A31AirlineName = "";
         lV7cAirlineName = "";
         H000I2_A32AirlineDiscountPercentage = new short[1] ;
         H000I2_A31AirlineName = new string[] {""} ;
         H000I2_A30AirlineID = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0090__default(),
            new Object[][] {
                new Object[] {
               H000I2_A32AirlineDiscountPercentage, H000I2_A31AirlineName, H000I2_A30AirlineID
               }
               , new Object[] {
      ...
      private short[] H000I2_A32AirlineDiscountPercentage ;
      private string[] H000I2_A31AirlineName ;
      private short[] H000I2_A30AirlineID ;
   ...
   public class gx0090__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000I2( IGxContext context ,
                                             string AV7cAirlineName ,
                                             short AV8cAirlineDiscountPercentage ,
                                             string A31AirlineName ,
                                             short A32AirlineDiscountPercentage ,
                                             short AV6cAirlineID )
      {
