...
namespace GeneXus.Programs {
   public class gx00b1 : GXDataArea
   {
      ...
      public void execute( short aP0_pFlyghtId ,
                           ...
                           out string aP2_pFlyghtSeatChar )
      {
         this.AV9pFlyghtId = aP0_pFlyghtId;
         this.AV10pFlyghtSeatId = 0 ;
         this.AV11pFlyghtSeatChar = "" ;
         ExecuteImpl();
         aP1_pFlyghtSeatId=this.AV10pFlyghtSeatId;
         aP2_pFlyghtSeatChar=this.AV11pFlyghtSeatChar;
      }
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV11pFlyghtSeatChar = GetPar( "pFlyghtSeatChar");
                  AssignAttri("", false, "AV11pFlyghtSeatChar", AV11pFlyghtSeatChar);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7cFlyghtSeatChar = GetPar( "cFlyghtSeatChar");
         cmbavCflyghtseatlocation.FromJSonString( GetNextPar( ));
         AV8cFlyghtSeatLocation = GetPar( "cFlyghtSeatLocation");
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cFlyghtSeatId, AV7cFlyghtSeatChar, AV8cFlyghtSeatLocation, AV9pFlyghtId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00b1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pFlyghtId,4,0)),UrlEncode(StringUtil.LTrimStr(AV10pFlyghtSeatId,4,0)),UrlEncode(StringUtil.RTrim(AV11pFlyghtSeatChar))}, new string[] {"pFlyghtId","pFlyghtSeatId","pFlyghtSeatChar"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCFLYGHTSEATCHAR", StringUtil.RTrim( AV7cFlyghtSeatChar));
         GxWebStd.gx_hidden_field( context, "GXH_vCFLYGHTSEATLOCATION", StringUtil.RTrim( AV8cFlyghtSeatLocation));
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vPFLYGHTSEATCHAR", StringUtil.RTrim( AV11pFlyghtSeatChar));
      ...
      {
         return formatLink("gx00b1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pFlyghtId,4,0)),UrlEncode(StringUtil.LTrimStr(AV10pFlyghtSeatId,4,0)),UrlEncode(StringUtil.RTrim(AV11pFlyghtSeatChar))}, new string[] {"pFlyghtId","pFlyghtSeatId","pFlyghtSeatChar"})  ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflyghtseatidfilter_Internalname, "Flyght Seat Id", "", "", lblLblflyghtseatidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00B1.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCflyghtseatid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cFlyghtSeatId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCflyghtseatid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cFlyghtSeatId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cFlyghtSeatId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCflyghtseatid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCflyghtseatid_Visible, edtavCflyghtseatid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflyghtseatcharfilter_Internalname, "Flyght Seat Char", "", "", lblLblflyghtseatcharfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCflyghtseatchar, cmbavCflyghtseatchar_Internalname, StringUtil.RTrim( AV7cFlyghtSeatChar), 1, cmbavCflyghtseatchar_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavCflyghtseatchar.Visible, cmbavCflyghtseatchar.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "", true, 0, "HLP_Gx00B1.htm");
            cmbavCflyghtseatchar.CurrentValue = StringUtil.RTrim( AV7cFlyghtSeatChar);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflyghtseatlocationfilter_Internalname, "Flyght Seat Location", "", "", lblLblflyghtseatlocationfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCflyghtseatlocation, cmbavCflyghtseatlocation_Internalname, StringUtil.RTrim( AV8cFlyghtSeatLocation), 1, cmbavCflyghtseatlocation_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavCflyghtseatlocation.Visible, cmbavCflyghtseatlocation.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "", true, 0, "HLP_Gx00B1.htm");
            cmbavCflyghtseatlocation.CurrentValue = StringUtil.RTrim( AV8cFlyghtSeatLocation);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e140k1_client"+"'", TempTags, "", 2, "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCFLYGHTSEATCHAR"), AV7cFlyghtSeatChar) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cflyghtseatlocation Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCFLYGHTSEATLOCATION"), AV8cFlyghtSeatLocation) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        string AV7cFlyghtSeatChar ,
                                        string AV8cFlyghtSeatLocation ,
                                        short AV9pFlyghtId )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_FLYGHTSEATCHAR", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A35FlyghtSeatChar, "")), context));
         GxWebStd.gx_hidden_field( context, "FLYGHTSEATCHAR", StringUtil.RTrim( A35FlyghtSeatChar));
      }
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV7cFlyghtSeatChar = cmbavCflyghtseatchar.getValidValue(AV7cFlyghtSeatChar);
            AssignAttri("", false, "AV7cFlyghtSeatChar", AV7cFlyghtSeatChar);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavCflyghtseatchar.CurrentValue = StringUtil.RTrim( AV7cFlyghtSeatChar);
         ...
         {
            AV8cFlyghtSeatLocation = cmbavCflyghtseatlocation.getValidValue(AV8cFlyghtSeatLocation);
            AssignAttri("", false, "AV8cFlyghtSeatLocation", AV8cFlyghtSeatLocation);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavCflyghtseatlocation.CurrentValue = StringUtil.RTrim( AV8cFlyghtSeatLocation);
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cFlyghtSeatChar = StringUtil.PadR( StringUtil.RTrim( AV7cFlyghtSeatChar), 1, "%");
            lV8cFlyghtSeatLocation = StringUtil.PadR( StringUtil.RTrim( AV8cFlyghtSeatLocation), 1, "%");
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {AV9pFlyghtId, AV6cFlyghtSeatId, lV7cFlyghtSeatChar, lV8cFlyghtSeatLocation, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_44_idx = 1;
            sGXsfl_44_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_44_idx), 4, 0), 4, "0");
            SubsflControlProps_442( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A20FlyghtId = H000K2_A20FlyghtId[0];
               A34FlyghtSeatLocation = H000K2_A34FlyghtSeatLocation[0];
               A35FlyghtSeatChar = H000K2_A35FlyghtSeatChar[0];
               A33FlyghtSeatId = H000K2_A33FlyghtSeatId[0];
               /* Execute user event: Load */
               E160K2 ();
      ...
      protected void send_integrity_lvl_hashes0K2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_FLYGHTSEATCHAR"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, StringUtil.RTrim( context.localUtil.Format( A35FlyghtSeatChar, "")), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV8cFlyghtSeatLocation = StringUtil.PadR( StringUtil.RTrim( AV8cFlyghtSeatLocation), 1, "%");
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {AV9pFlyghtId, AV6cFlyghtSeatId, lV7cFlyghtSeatChar, lV8cFlyghtSeatLocation});
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV7cFlyghtSeatChar = cgiGet( cmbavCflyghtseatchar_Internalname);
            AssignAttri("", false, "AV7cFlyghtSeatChar", AV7cFlyghtSeatChar);
            ...
            AV8cFlyghtSeatLocation = cgiGet( cmbavCflyghtseatlocation_Internalname);
            AssignAttri("", false, "AV8cFlyghtSeatLocation", AV8cFlyghtSeatLocation);
      ...
      protected void E170K2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV10pFlyghtSeatId = A33FlyghtSeatId;
         AssignAttri("", false, "AV10pFlyghtSeatId", StringUtil.LTrimStr( (decimal)(AV10pFlyghtSeatId), 4, 0));
         AV11pFlyghtSeatChar = A35FlyghtSeatChar;
         AssignAttri("", false, "AV11pFlyghtSeatChar", AV11pFlyghtSeatChar);
         context.setWebReturnParms(new Object[] {(short)AV10pFlyghtSeatId,(string)AV11pFlyghtSeatChar});
         context.setWebReturnParmsMetadata(new Object[] {"AV10pFlyghtSeatId","AV11pFlyghtSeatChar"});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV10pFlyghtSeatId", StringUtil.LTrimStr( (decimal)(AV10pFlyghtSeatId), 4, 0));
         AV11pFlyghtSeatChar = (string)getParm(obj,2);
         AssignAttri("", false, "AV11pFlyghtSeatChar", AV11pFlyghtSeatChar);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245308514612", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00b1.js", "?20245308514612", false, true);
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A33FlyghtSeatId), 4, 0, ".", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A35FlyghtSeatChar))+"'"+"]);";
      ...
      protected void StartGridControl44( )
      {
         ...
         else
         {
            ...
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( cmbFlyghtSeatLocation.Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cFlyghtSeatId","fld":"vCFLYGHTSEATID","pic":"ZZZ9"},{"av":"cmbavCflyghtseatchar"},{"av":"AV7cFlyghtSeatChar","fld":"vCFLYGHTSEATCHAR"},{"av":"cmbavCflyghtseatlocation"},{"av":"AV8cFlyghtSeatLocation","fld":"vCFLYGHTSEATLOCATION"},{"av":"AV9pFlyghtId","fld":"vPFLYGHTID","pic":"ZZZ9"}]}""");
         setEventMetadata("'TOGGLE'","""{"handler":"E140K1","iparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]""");
         setEventMetadata("'TOGGLE'",""","oparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]}""");
         setEventMetadata("LBLFLYGHTSEATIDFILTER.CLICK","""{"handler":"E110K1","iparms":[{"av":"divFlyghtseatidfiltercontainer_Class","ctrl":"FLYGHTSEATIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLFLYGHTSEATCHARFILTER.CLICK","""{"handler":"E120K1","iparms":[{"av":"divFlyghtseatcharfiltercontainer_Class","ctrl":"FLYGHTSEATCHARFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLFLYGHTSEATLOCATIONFILTER.CLICK","""{"handler":"E130K1","iparms":[{"av":"divFlyghtseatlocationfiltercontainer_Class","ctrl":"FLYGHTSEATLOCATIONFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E170K2","iparms":[{"av":"A33FlyghtSeatId","fld":"FLYGHTSEATID","pic":"ZZZ9","hsh":true},{"av":"cmbFlyghtSeatChar"},{"av":"A35FlyghtSeatChar","fld":"FLYGHTSEATCHAR","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV10pFlyghtSeatId","fld":"vPFLYGHTSEATID","pic":"ZZZ9"},{"av":"AV11pFlyghtSeatChar","fld":"vPFLYGHTSEATCHAR"}]}""");
         setEventMetadata("GRID1_FIRSTPAGE","""{"handler":"subgrid1_firstpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cFlyghtSeatId","fld":"vCFLYGHTSEATID","pic":"ZZZ9"},{"av":"cmbavCflyghtseatchar"},{"av":"AV7cFlyghtSeatChar","fld":"vCFLYGHTSEATCHAR"},{"av":"cmbavCflyghtseatlocation"},{"av":"AV8cFlyghtSeatLocation","fld":"vCFLYGHTSEATLOCATION"},{"av":"AV9pFlyghtId","fld":"vPFLYGHTID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_PREVPAGE","""{"handler":"subgrid1_previouspage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cFlyghtSeatId","fld":"vCFLYGHTSEATID","pic":"ZZZ9"},{"av":"cmbavCflyghtseatchar"},{"av":"AV7cFlyghtSeatChar","fld":"vCFLYGHTSEATCHAR"},{"av":"cmbavCflyghtseatlocation"},{"av":"AV8cFlyghtSeatLocation","fld":"vCFLYGHTSEATLOCATION"},{"av":"AV9pFlyghtId","fld":"vPFLYGHTID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_NEXTPAGE","""{"handler":"subgrid1_nextpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cFlyghtSeatId","fld":"vCFLYGHTSEATID","pic":"ZZZ9"},{"av":"cmbavCflyghtseatchar"},{"av":"AV7cFlyghtSeatChar","fld":"vCFLYGHTSEATCHAR"},{"av":"cmbavCflyghtseatlocation"},{"av":"AV8cFlyghtSeatLocation","fld":"vCFLYGHTSEATLOCATION"},{"av":"AV9pFlyghtId","fld":"vPFLYGHTID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_LASTPAGE","""{"handler":"subgrid1_lastpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cFlyghtSeatId","fld":"vCFLYGHTSEATID","pic":"ZZZ9"},{"av":"cmbavCflyghtseatchar"},{"av":"AV7cFlyghtSeatChar","fld":"vCFLYGHTSEATCHAR"},{"av":"cmbavCflyghtseatlocation"},{"av":"AV8cFlyghtSeatLocation","fld":"vCFLYGHTSEATLOCATION"},{"av":"AV9pFlyghtId","fld":"vPFLYGHTID","pic":"ZZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         A34FlyghtSeatLocation = "";
         lV7cFlyghtSeatChar = "";
         lV8cFlyghtSeatLocation = "";
         H000K2_A20FlyghtId = new short[1] ;
         H000K2_A34FlyghtSeatLocation = new string[] {""} ;
         H000K2_A35FlyghtSeatChar = new string[] {""} ;
         H000K2_A33FlyghtSeatId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00b1__default(),
            new Object[][] {
                new Object[] {
               H000K2_A20FlyghtId, H000K2_A34FlyghtSeatLocation, H000K2_A35FlyghtSeatChar, H000K2_A33FlyghtSeatId
               }
               , new Object[] {
      ...
      private string AV11pFlyghtSeatChar ;
      ...
      private string AV7cFlyghtSeatChar ;
      private string AV8cFlyghtSeatLocation ;
      ...
      private string lV7cFlyghtSeatChar ;
      private string lV8cFlyghtSeatLocation ;
      ...
      private short[] H000K2_A20FlyghtId ;
      private string[] H000K2_A34FlyghtSeatLocation ;
      private string[] H000K2_A35FlyghtSeatChar ;
      private short[] H000K2_A33FlyghtSeatId ;
      private long[] H000K3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP1_pFlyghtSeatId ;
      private string aP2_pFlyghtSeatChar ;
   }
   ...
   public class gx00b1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A20FlyghtId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [FlyghtId], [FlyghtSeatLocation], [FlyghtSeatChar], [FlyghtSeatId]";
         sFromString = " FROM [FlyghtSeat]";
         sOrderString = "";
         AddWhere(sWhereString, "([FlyghtId] = @AV9pFlyghtId and [FlyghtSeatId] >= @AV6cFlyghtSeatId)");
         AddWhere(sWhereString, "([FlyghtSeatChar] like @lV7cFlyghtSeatChar)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV8cFlyghtSeatLocation)) )
         {
            AddWhere(sWhereString, "([FlyghtSeatLocation] like @lV8cFlyghtSeatLocation)");
         }
         else
         {
            GXv_int1[3] = 1;
         }
         sOrderString += " ORDER BY [FlyghtId], [FlyghtSeatId], [FlyghtSeatChar]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000K2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H000K3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cFlyghtSeatChar",GXType.NChar,1,0) ,
          new ParDef("@lV8cFlyghtSeatLocation",GXType.NChar,1,0) ,
