...
namespace GeneXus.Programs {
   public class customer : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCustomerAddedDate_Internalname, context.localUtil.Format(A17CustomerAddedDate, "99/99/99"), context.localUtil.Format( A17CustomerAddedDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerAddedDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerAddedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Customer.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z17CustomerAddedDate = context.localUtil.CToD( cgiGet( "Z17CustomerAddedDate"), 0);
            ...
            A17CustomerAddedDate = context.localUtil.CToD( cgiGet( edtCustomerAddedDate_Internalname), 1);
            AssignAttri("", false, "A17CustomerAddedDate", context.localUtil.Format(A17CustomerAddedDate, "99/99/99"));
            ...
            A17CustomerAddedDate = context.localUtil.CToD( cgiGet( edtCustomerAddedDate_Internalname), 1);
            AssignAttri("", false, "A17CustomerAddedDate", context.localUtil.Format(A17CustomerAddedDate, "99/99/99"));
            forbiddenHiddens.Add("CustomerAddedDate", context.localUtil.Format(A17CustomerAddedDate, "99/99/99"));
            hsh = cgiGet( "hsh");
      ...
      protected void ZM011( short GX_JID )
      {
         if ( ( GX_JID == 5 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z17CustomerAddedDate = T00013_A17CustomerAddedDate[0];
            }
            else
            {
               ...
               Z17CustomerAddedDate = A17CustomerAddedDate;
            }
         }
         if ( GX_JID == -5 )
         {
      ...
      {
         if ( IsIns( )  && (DateTime.MinValue==A17CustomerAddedDate) && ( Gx_BScreen == 0 ) )
         {
            A17CustomerAddedDate = Gx_date;
            AssignAttri("", false, "A17CustomerAddedDate", context.localUtil.Format(A17CustomerAddedDate, "99/99/99"));
         }
         else
         {
      ...
      protected void Load011( )
      {
         ...
         if ( (pr_default.getStatus(2) != 101) )
         {
            ...
            AssignAttri("", false, "A5CustomerPhone", A5CustomerPhone);
            A17CustomerAddedDate = T00014_A17CustomerAddedDate[0];
            AssignAttri("", false, "A17CustomerAddedDate", context.localUtil.Format(A17CustomerAddedDate, "99/99/99"));
            ZM011( -5) ;
         }
         pr_default.close(2);
      ...
      protected void CheckExtendedTable011( )
      {
         ...
         {
            GX_msglist.addItem("Complete el nombre del cliente", 1, "CUSTOMERNAME");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Complete el telefono del cliente", 0, "CUSTOMERPHONE");
         }
      }
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A5CustomerPhone", A5CustomerPhone);
            A17CustomerAddedDate = T00013_A17CustomerAddedDate[0];
            AssignAttri("", false, "A17CustomerAddedDate", context.localUtil.Format(A17CustomerAddedDate, "99/99/99"));
            Z1CustomerId = A1CustomerId;
            sMode1 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void CheckOptimisticConcurrency011( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z2CustomerName, T00012_A2CustomerName[0]) != 0 ) || ( StringUtil.StrCmp(Z3CustomerLastName, T00012_A3CustomerLastName[0]) != 0 ) || ( StringUtil.StrCmp(Z4CustomerAddress, T00012_A4CustomerAddress[0]) != 0 ) || ( StringUtil.StrCmp(Z5CustomerPhone, T00012_A5CustomerPhone[0]) != 0 ) || ( DateTimeUtil.ResetTime ( Z17CustomerAddedDate ) != DateTimeUtil.ResetTime ( T00012_A17CustomerAddedDate[0] ) ) )
            {
               ...
               if ( DateTimeUtil.ResetTime ( Z17CustomerAddedDate ) != DateTimeUtil.ResetTime ( T00012_A17CustomerAddedDate[0] ) )
               {
                  GXUtil.WriteLog("customer:[seudo value changed for attri]"+"CustomerAddedDate");
                  GXUtil.WriteLogRaw("Old: ",Z17CustomerAddedDate);
                  GXUtil.WriteLogRaw("Current: ",T00012_A17CustomerAddedDate[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00018 */
                     pr_default.execute(6, new Object[] {A1CustomerId, A2CustomerName, A3CustomerLastName, A4CustomerAddress, A5CustomerPhone, A17CustomerAddedDate});
                     pr_default.close(6);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00019 */
                     pr_default.execute(7, new Object[] {A2CustomerName, A3CustomerLastName, A4CustomerAddress, A5CustomerPhone, A17CustomerAddedDate, A1CustomerId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Customer");
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z17CustomerAddedDate", context.localUtil.DToC( Z17CustomerAddedDate, 0, "/"));
      ...
      protected void InitializeNonKey011( )
      {
         ...
         Z4CustomerAddress = "";
         Z5CustomerPhone = "";
         Z17CustomerAddedDate = DateTime.MinValue;
      }
      ...
      {
         A17CustomerAddedDate = i17CustomerAddedDate;
         AssignAttri("", false, "A17CustomerAddedDate", context.localUtil.Format(A17CustomerAddedDate, "99/99/99"));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245291037101", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customer.js", "?20245291037101", false, true);
      ...
      public void Valid_Customerid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z4CustomerAddress", Z4CustomerAddress);
         GxWebStd.gx_hidden_field( context, "Z5CustomerPhone", StringUtil.RTrim( Z5CustomerPhone));
         GxWebStd.gx_hidden_field( context, "Z17CustomerAddedDate", context.localUtil.Format(Z17CustomerAddedDate, "99/99/99"));
         AssignProp("", false, bttBtn_delete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_delete_Enabled), 5, 0), true);
         AssignProp("", false, bttBtn_enter_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_enter_Enabled), 5, 0), true);
         SendCloseFormHiddens( ) ;
      }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A17CustomerAddedDate","fld":"CUSTOMERADDEDDATE"}]}""");
         setEventMetadata("VALID_CUSTOMERID","""{"handler":"Valid_Customerid","iparms":[{"av":"A1CustomerId","fld":"CUSTOMERID","pic":"ZZZ9"},{"av":"Gx_date","fld":"vTODAY"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"A17CustomerAddedDate","fld":"CUSTOMERADDEDDATE"}]""");
      ...
      public override void initialize( )
      {
         ...
         gxphoneLink = "";
         A5CustomerPhone = "";
         A17CustomerAddedDate = DateTime.MinValue;
         ...
         T00014_A17CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         ...
         T00013_A17CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         sMode1 = "";
         ...
         T00012_A17CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         T000111_A1CustomerId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         i17CustomerAddedDate = DateTime.MinValue;
         ZZ2CustomerName = "";
         ZZ3CustomerLastName = "";
         ZZ4CustomerAddress = "";
         ZZ5CustomerPhone = "";
         ZZ17CustomerAddedDate = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customer__default(),
            new Object[][] {
                new Object[] {
               T00012_A1CustomerId, T00012_A2CustomerName, T00012_A3CustomerLastName, T00012_A4CustomerAddress, T00012_A5CustomerPhone, T00012_A17CustomerAddedDate
               }
               , new Object[] {
               T00013_A1CustomerId, T00013_A2CustomerName, T00013_A3CustomerLastName, T00013_A4CustomerAddress, T00013_A5CustomerPhone, T00013_A17CustomerAddedDate
               }
               , new Object[] {
               T00014_A1CustomerId, T00014_A2CustomerName, T00014_A3CustomerLastName, T00014_A4CustomerAddress, T00014_A5CustomerPhone, T00014_A17CustomerAddedDate
               }
               , new Object[] {
               T00015_A1CustomerId
               }
      ...
      private DateTime Z17CustomerAddedDate ;
      private DateTime A17CustomerAddedDate ;
      private DateTime Gx_date ;
      private DateTime i17CustomerAddedDate ;
      private DateTime ZZ17CustomerAddedDate ;
      ...
      private DateTime[] T00014_A17CustomerAddedDate ;
      ...
      private DateTime[] T00013_A17CustomerAddedDate ;
      ...
      private DateTime[] T00012_A17CustomerAddedDate ;
   ...
   public class customer__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00012", "SELECT [CustomerId], [CustomerName], [CustomerLastName], [CustomerAddress], [CustomerPhone], [CustomerAddedDate] FROM [Customer] WITH (UPDLOCK) WHERE [CustomerId] = @CustomerId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00012,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00013", "SELECT [CustomerId], [CustomerName], [CustomerLastName], [CustomerAddress], [CustomerPhone], [CustomerAddedDate] FROM [Customer] WHERE [CustomerId] = @CustomerId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00013,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00014", "SELECT TM1.[CustomerId], TM1.[CustomerName], TM1.[CustomerLastName], TM1.[CustomerAddress], TM1.[CustomerPhone], TM1.[CustomerAddedDate] FROM [Customer] TM1 WHERE TM1.[CustomerId] = @CustomerId ORDER BY TM1.[CustomerId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT00014,100, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T00018", "INSERT INTO [Customer]([CustomerId], [CustomerName], [CustomerLastName], [CustomerAddress], [CustomerPhone], [CustomerAddedDate]) VALUES(@CustomerId, @CustomerName, @CustomerLastName, @CustomerAddress, @CustomerPhone, @CustomerAddedDate)", GxErrorMask.GX_NOMASK,prmT00018)
             ,new CursorDef("T00019", "UPDATE [Customer] SET [CustomerName]=@CustomerName, [CustomerLastName]=@CustomerLastName, [CustomerAddress]=@CustomerAddress, [CustomerPhone]=@CustomerPhone, [CustomerAddedDate]=@CustomerAddedDate  WHERE [CustomerId] = @CustomerId", GxErrorMask.GX_NOMASK,prmT00019)
